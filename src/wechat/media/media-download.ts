...
/**
 * Persist a buffer to local storage.
 *
 * NOTE: the original delegated to the OpenClaw framework's unified media store
 * (`channelRuntime.media.saveMediaBuffer`); in the DSH port this is a plain
