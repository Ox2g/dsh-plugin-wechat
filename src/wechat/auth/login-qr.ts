...
export type WeixinQrWaitResult = {
   ...
   * this instance, so no new credentials are issued and existing local
   * credentials remain valid. Callers should treat this as a successful
